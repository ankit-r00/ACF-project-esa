...
class WPLNST_Views_Pro_Scans_Results extends WPLNST_Views_Scans_Results {
	...
	protected function display_tablenav($which) {
		...
		<div id="wplnst-results-bulkactions-area-<?php echo $which; ?>" class="wplnst-results-bulkactions-area wplnst-display-none"
			<?php if ('top' == $which) echo ' data-label-bulk-unlink="'.esc_attr__('Unlink URLs', 'wplnst').'"
			 data-label-bulk-ignore="'.esc_attr__('Ignore results', 'wplnst').'"
			 data-label-bulk-unignore="'.esc_attr__('Undo ignore results', 'wplnst').'"
			 data-label-bulk-anchor="'.esc_attr__('Anchor text edition', 'wplnst').'"
			 data-label-bulk-url="'.esc_attr__('URL edition', 'wplnst').'"
			 data-label-bulk-status="'.esc_attr__('URL recheck status', 'wplnst').'"
			 data-label-bulk-redir="'.esc_attr__('Apply redirections', 'wplnst').'"
			 data-label-bulk-nofollow="'.esc_attr__('Add nofollow', 'wplnst').'"
			 data-label-bulk-dofollow="'.esc_attr__('Remove nofollow', 'wplnst').'"'; ?>></div><?php
	}
